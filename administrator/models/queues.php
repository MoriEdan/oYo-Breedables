 ...
 */
class BreedableModelQueues extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.mother_name', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__breedable_queued` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.mother_name LIKE '.$search.'  OR  a.mother_id LIKE '.$search.'  OR  a.father_name LIKE '.$search.'  OR  a.father_id LIKE '.$search.'  OR  a.status LIKE '.$search.' )');
            }
        }
