...
<form action="<?php echo JRoute::_('index.php?option=com_breedable&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="configuration-form" class="form-validate">
    ...
    <div class="form-horizontal">
        ...
        <div class="row-fluid">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('breedable_name'); ?></div>
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('breedable_dob'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('breedable_dob'); ?></div>
			</div>
			<div class="control-group">
