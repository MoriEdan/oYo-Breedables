...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_breedable&task=configurations.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'configurationList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_breedable&view=configurations'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="configurationList">
			<thead>
				<tr>
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'configurations.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
