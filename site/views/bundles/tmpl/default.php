...
<script type="text/javascript">
    function deleteItem(item_id){
        if(confirm("<?php echo JText::_('COM_BREEDABLE_DELETE_MESSAGE'); ?>")){
            document.getElementById('form-bundle-delete-' + item_id).submit();
        }
    }
</script>
...
<?php $show = false; ?>
        <?php foreach ($this->items as $item) : ?>
				...
				<?php
						...
						?>
							<li>
								<a href="<?php echo JRoute::_('index.php?option=com_breedable&view=bundle&id=' . (int)$item->id); ?>"><?php echo $item->breed; ?></a>
							</li>
