 ...
 */
class BreedableControllerBirths extends BreedableController {
    ...
    public function edit() {
        ...
        $previousId = (int) $app->getUserState('com_breedable.edit.births.id');
        $editId = JFactory::getApplication()->input->getInt('id', null, 'array');

        // Set the user id for the user to edit in the session.
        $app->setUserState('com_breedable.edit.births.id', $editId);

        // Get the model.
        $model = $this->getModel('Births', 'BreedableModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_breedable&view=birthsform&layout=edit', false));
    }
    ...
    public function publish() {
        ...
        // Clear the profile id from the session.
        $app->setUserState('com_breedable.edit.births.id', null);

        // Flush the data from the session.
        $app->setUserState('com_breedable.edit.births.data', null);
